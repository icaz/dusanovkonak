...
<div class="login-box">
  ...
  <div class="card">
    ...
    <div class="input-group mb-3">
          <input name="nick" type="text"  class="form-control is-valid" value="<?php echo $_SESSION['nick']; ?>" disabled>
...
<?php if (isset($_SESSION['nick_comment'])) { ?>
        <div class="alert alert-warning alert-dismissible small">
          <button type="button" class="close" data-dismiss="alert">&times;</button>
          <?php echo  $_SESSION['nick_comment']; ?>
        </div>
<?php  unset($_SESSION['nick_comment']);
        } 
?>
